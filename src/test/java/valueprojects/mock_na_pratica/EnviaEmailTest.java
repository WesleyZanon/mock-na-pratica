...
public class EnviaEmailTest {
	@Test
	public void deveEnviarEmailAoVencedorAposFinalizarESalverJogoDaSemanaAnteriorESalvarVencedor() {
		...
		enviaEmail.enviarEmailParaVencedor(emailVencedor, vencedor);
		verify(enviaEmail, times(1)).enviarEmailParaVencedor(emailVencedor, vencedor);
	}
}
